...
describe "SECTION: Primitive Operations (0x3_)" do
  opcode "0x30 add       ", [5_u8], 0x01, 2, 0x01, 3, 0x30
  opcode "0x31 sub       ", [1_u8], 0x01, 3, 0x01, 2, 0x31
  opcode "0x32 mul       ", [6_u8], 0x01, 2, 0x01, 3, 0x32
  opcode "0x33 div       ", [2_u8], 0x01, 4, 0x01, 2, 0x33
  opcode "0x34 mod       ", [1_u8], 0x01, 5, 0x01, 2, 0x34
  opcode "0x35 shl       ", [0b10010000], 0x01, 0b00100100, 0x01, 2, 0x35
  opcode "0x36 shr       ", [0b00001001], 0x01, 0b00100100, 0x01, 2, 0x36
  opcode "0x37 not (Int) ", [0b11011011], 0x01, 0b00100100, 0x37
  opcode "0x37 not (Bool)", [false],      0x02, 0x1, 0x37
  opcode "0x38 and (Int) ", [0b00100000], 0x01, 0b00100100, 0x01, 0b11111011, 0x38
  opcode "0x38 and (Bool)", [true],       0x02, 0x1, 0x02, 0x1, 0x38
  opcode "0x39 or  (Int) ", [0b10110100], 0x01, 0b00100100, 0x01, 0b10010000, 0x39
  opcode "0x39 or  (Bool)", [false],      0x02, 0x0, 0x02, 0x0, 0x39
